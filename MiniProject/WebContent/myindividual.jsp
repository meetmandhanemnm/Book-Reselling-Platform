...
<br>
	...
	<br>
	<input class="button1" type="button" value='Edit Advert' onclick="location.href='editad?adid=<c:out value="${adlist.aid}"/>'"/>
	&nbsp;&nbsp;
	<input class="button1" type="button" value='Delete Advert' onclick="location.href='deletead?adid=<c:out value="${adlist.aid}"/>'"/>
</div>
</body>
</html>