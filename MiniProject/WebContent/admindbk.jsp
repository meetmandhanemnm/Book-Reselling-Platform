...
<br><br><br>
	...
	<font class="two">Book Details</font>
			...
			<form autocomplete="off" name="myform" action="updatebookd">
			  ...
			  <fieldset id="section1">
				...
				<tr style="padding:20px">
					...
					<input type="text" name="title" id="title" size="50" value="<c:out value="${bk.title}" />" style="border-radius:20px; padding:5px;" disabled/>
					</td>
					
					<td align="right" style="padding:20px"> <label for="pub"><b> Publication :</b></label>
					<input type="text" name="pub" id="pub" size="50" value="<c:out value="${bk.pub}" />" style="border-radius:20px; padding:5px;" disabled/>
					</td>
				</tr>
				...
				<tr style="padding:20px">
					...
					<input type="text" name="a1" id="a1" size="50" value="<c:out value="${bk.author1}" />" style="border-radius:20px; padding:5px;" disabled/>
					</td>
					
					<td align="right" style="padding:20px; float:left;"><label for="a2"><b>Author 2 :</b></label>
					<input type="text" name="a2" id="a2" size="50" value="<c:out value="${bk.author2}" />" style="border-radius:20px; padding:5px;" disabled/>
					</td>
				</tr>
				</table>
				</center>
