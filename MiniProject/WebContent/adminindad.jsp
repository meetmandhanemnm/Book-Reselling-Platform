...
<br>
	...
	<br>
	<input class="button1" type="button" value='Edit Advert' onclick="location.href='aeditad?adid=<c:out value="${adlist.aid}"/>'"/>
	&nbsp;&nbsp;
	<input class="button1" type="button" value='Delete Advert' onclick="location.href='adeletead?adid=<c:out value="${adlist.aid}"/>'"/>
</div>
</body>
</html>