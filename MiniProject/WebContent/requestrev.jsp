...
<br><br><br>
	...
	<font class="two">Request Review</font>
			<br><br>

			<form autocomplete="off" name="myform" action="reqrev">
			  ...
			  <fieldset id="section1">
				...
				<tr style="padding:20px">
					...
					<input type="text" name="title" id="title" size="50"  style="border-radius:20px; padding:5px;" required>
					</td>
					
					<td align="right" style="padding:20px"> <label for="pub"><b> Publication :</b></label>
					<input type="text" name="pub" id="pub" size="50"  style="border-radius:20px; padding:5px;" required>
					</td>
				</tr>
				...
				<tr style="padding:20px">
					...
					<input type="text" name="a1" id="a1" size="50" style="border-radius:20px; padding:5px;" required>
					</td>
					
					<td align="right" style="padding:20px; float:left;"><label for="a2"><b>Author 2 :</b></label>
					<input type="text" name="a2" id="a2" size="50"  style="border-radius:20px; padding:5px;">
					</td>
				</tr>
				</table>
				</center>
